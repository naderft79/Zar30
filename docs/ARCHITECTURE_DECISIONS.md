...
- ساختار بخش‌ها مطابق مرجع: Hero دوستونه + کارت قیمت زنده → کارت‌های اعتماد → marquee نشان‌ها → بخش بازار با تب روزانه/ماهانه/سالانه → بخش‌های ویژگی دوستونه → stepهای ۰۱-۰۴ → تحویل فیزیکی → FAQ → پشتیبانی → مجوزها → CTA نهایی.
