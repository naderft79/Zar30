...
- ترتیب جدید بخش‌ها: Trust Cards → Marquee → بازار با تب روزانه/ماهانه/سالانه و نمودار → سه Feature Section دوستونه → stepهای ۰۱-۰۴ → تحویل فیزیکی → FAQ → پشتیبانی → مجوزها → Final CTA
