// ============================================
// Zarnama - Landing Page Content Data
// ============================================
...
export const FEATURES: Feature[] = [
  ...
  },
  {
    icon: Send,
    title: 'انتقال طلا',
    description: 'به دیگر کاربران زرنما طلا هدیه دهید یا منتقل کنید — سریع و بدون واسطه.',
  },
]

// ---------- چرا زرنما ----------
export const WHY_ZARNAMA: Feature[] = [
  {
    icon: ShieldCheck,
    title: 'امنیت چندلایه',
...
export const FAQS: Faq[] = [
  {
    question: 'زرنما چیست و چگونه کار می‌کند؟',
    answer:
      'زرنما پلتفرمی برای خرید، فروش و نگهداری طلای آب‌شده ۱۸ عیار به‌صورت دیجیتال است. شما می‌توانید با هر مبلغی طلا بخرید، آن را در حساب خود نگه دارید، هر زمان بفروشید یا به‌صورت فیزیکی تحویل بگیرید.',
  },
  {
    question: 'آیا طلای من واقعاً وجود دارد؟',
    answer:
      'بله. هر گرم طلای دیجیتال در زرنما متناظر با طلای فیزیکی نگهداری‌شده در خزانه‌های امن است. تمام تراکنش‌ها در دفتر کل دوطرفه (Double-Entry) ثبت و قابل حسابرسی هستند.',
  },
  {
    question: 'حداقل مبلغ خرید طلا چقدر است؟',
    answer:
      'شما می‌توانید با مبالغ بسیار کوچک شروع کنید. هدف زرنما این است که سرمایه‌گذاری روی طلا برای همه در دسترس باشد.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'زرنما از احراز هویت چندمرحله‌ای (OTP + رمز عبور + 2FA اختیاری)، رمزنگاری داده‌ها، ثبت لاگ امنیتی و زیرساخت مالی قابل حسابرسی استفاده می‌کند. جزئیات بیشتر در صفحه امنیت آمده است.',
  },
  {
    question: 'کارمزد خرید و فروش چقدر است؟',
    answer:
      'ساختار کارمزد زرنما شفاف است و قبل از هر تراکنش به‌صورت کامل نمایش داده می‌شود. هیچ هزینه پنهانی وجود ندارد.',
  },
  {
